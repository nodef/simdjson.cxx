...
<img src="https://github.com/simdjson/simdjson/blob/master/images/logo.png" width="10%" style="float: right">
...
And then include `simdjson.h` as follows:
```cxx
// main.cxx
#define SIMDJSON_IMPLEMENTATION
#include "node_modules/simdjson.cxx/simdjson.h"
...
If you add the path `node_modules/simdjson.cxx` to your compiler's include paths.

```bash
$ clang++ -I./node_modules/simdjson.cxx main.cxx  # or, use g++
$ g++     -I./node_modules/simdjson.cxx main.cxx
```
...
1. Pull [twitter.json](https://github.com/simdjson/simdjson/blob/master/jsonexamples/twitter.json) into a directory.
...
```
3. `c++ -o quickstart quickstart.cpp`
4. `./quickstart`
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/simdjson.cxx)
